...
describe('Employee', () => {
  ...
  describe('Reading data', () => {
    before(async () => {
      ...
      const testEmpTwo = new Employee({ firstName: 'Amanda', lastName: 'Doe', department: 'HR' });
  ...
  describe('Creating data', () => {
    it('should insert new document with "insertOne" method', async () => {
      ...
      await employee.save();
      expect(employee.isNew).to.be.false; // instead of this:
  ...
  describe('Updating data', () => {
    ...
    it('should properly update multiple documents with "updateMany" method', async () => {
      await Employee.updateMany({}, { $set: { lastName: 'Done' }});
      const employees = await Employee.find();
  ...
  describe('Removing data', () => {
    ...
    it('should properly remove multiple documents with "deleteMany" method', async () => {
      await Employee.deleteMany();
      const removedEmployee = await Employee.findOne({ firstName: 'John' });
      const removedEmployeeTwo = await Employee.findOne({ firstName: 'Amanda' });
      expect(removedEmployee).to.be.null;
